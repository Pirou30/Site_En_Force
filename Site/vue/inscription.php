...
<form method="POST" name="formulaire" action="index.php?page=verif_inscription" onsubmit="return verifForm(this)" class="inscription">
  ...
  <div id="eveC">
   ...
   <p>
   <input id="telm" type="text" name="tel" onkeydown="if(event.keyCode==32) return false;" placeholder=" Téléphone" required title="Numéro de téléphone sans espace du type : 0102030405"/>
