<?php
 ...
 $req3 = $db->prepare('INSERT INTO droit(droit_d_utilisateur, date_de_modification_des_droits, id_utilisateur, id_piece)
 ...
 function suppr_piece($db)
 {
   ...
   if (!isset($empty['id_objet']))
   {
     ...
     $db->exec('DELETE FROM droit WHERE id_piece="'.$id_piece['id_piece'].'"');
   }
   else {
